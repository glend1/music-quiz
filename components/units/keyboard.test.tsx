...
describe("keyboard", () => {
    ...
    describe("Layout", () => {
        ...
        it("Should use the correct layout", () => {
            ...
            expect(callback).toHaveBeenNthCalledWith(3, {sharp: "C#", flat: "Db"}, "keydown");
            expect(callback).toHaveBeenNthCalledWith(4, {sharp: "C#", flat: "Db"}, "keyup");
            ...
            expect(callback).toHaveBeenNthCalledWith(7, {sharp: "D#", flat: "Eb"}, "keydown");
            expect(callback).toHaveBeenNthCalledWith(8, {sharp: "D#", flat: "Eb"}, "keyup");
            ...
            expect(callback).toHaveBeenNthCalledWith(13, {sharp: "F#", flat: "Gb"}, "keydown");
            expect(callback).toHaveBeenNthCalledWith(14, {sharp: "F#", flat: "Gb"}, "keyup");
            ...
            expect(callback).toHaveBeenNthCalledWith(17, {sharp: "G#", flat: "Ab"}, "keydown");
            expect(callback).toHaveBeenNthCalledWith(18, {sharp: "G#", flat: "Ab"}, "keyup");
            ...
            expect(callback).toHaveBeenNthCalledWith(21, {sharp: "A#", flat: "Bb"}, "keydown");
            expect(callback).toHaveBeenNthCalledWith(22, {sharp: "A#", flat: "Bb"}, "keyup");
    ...
    describe("Alphabetical", () => {
        ...
        it("Should use the correct layout", () => {
            ...
            expect(callback).toHaveBeenNthCalledWith(2, {natural: "C"}, "keyup");
            userEvent.keyboard("C");
            expect(callback).toHaveBeenNthCalledWith(3, {sharp: "C#", flat: "B"}, "keydown");
            expect(callback).toHaveBeenNthCalledWith(4, {sharp: "C#", flat: "B"}, "keyup");
            userEvent.keyboard("d");
            expect(callback).toHaveBeenNthCalledWith(5, {natural: "D"}, "keydown");
            expect(callback).toHaveBeenNthCalledWith(6, {natural: "D"}, "keyup");
            userEvent.keyboard("D");
            expect(callback).toHaveBeenNthCalledWith(7, {sharp: "D#", flat: "Db"}, "keydown");
            expect(callback).toHaveBeenNthCalledWith(8, {sharp: "D#", flat: "Db"}, "keyup");
            userEvent.keyboard("e");
            expect(callback).toHaveBeenNthCalledWith(9, {natural: "E"}, "keydown");
            expect(callback).toHaveBeenNthCalledWith(10, {natural: "E"}, "keyup");
            userEvent.keyboard("E");
            expect(callback).toHaveBeenNthCalledWith(11, {sharp: "F", flat: "Eb"}, "keydown");
            expect(callback).toHaveBeenNthCalledWith(12, {sharp: "F", flat: "Eb"}, "keyup");
            ...
            userEvent.keyboard("F");
            expect(callback).toHaveBeenNthCalledWith(15, {sharp: "F#", flat: "E"}, "keydown");
            expect(callback).toHaveBeenNthCalledWith(16, {sharp: "F#", flat: "E"}, "keyup");
            userEvent.keyboard("g");
            expect(callback).toHaveBeenNthCalledWith(17, {natural: "G"}, "keydown");
            expect(callback).toHaveBeenNthCalledWith(18, {natural: "G"}, "keyup");
            userEvent.keyboard("G");
            expect(callback).toHaveBeenNthCalledWith(19, {sharp: "G#", flat: "Gb"}, "keydown");
            expect(callback).toHaveBeenNthCalledWith(20, {sharp: "G#", flat: "Gb"}, "keyup");
            userEvent.keyboard("a");
            expect(callback).toHaveBeenNthCalledWith(21, {natural: "A"}, "keydown");
            expect(callback).toHaveBeenNthCalledWith(22, {natural: "A"}, "keyup");
            userEvent.keyboard("A");
            expect(callback).toHaveBeenNthCalledWith(23, {sharp: "A#", flat: "Ab"}, "keydown");
            expect(callback).toHaveBeenNthCalledWith(24, {sharp: "A#", flat: "Ab"}, "keyup");
            userEvent.keyboard("b");
            expect(callback).toHaveBeenNthCalledWith(25, {natural: "B"}, "keydown");
            expect(callback).toHaveBeenNthCalledWith(26, {natural: "B"}, "keyup");
            userEvent.keyboard("B");
            expect(callback).toHaveBeenNthCalledWith(27, {sharp: "C", flat: "Bb"}, "keydown");
            expect(callback).toHaveBeenNthCalledWith(28, {sharp: "C", flat: "Bb"}, "keyup");
        })
    })
