...
describe("questioncontrols", () => {
    ...
    describe("Interactions", () => {
        ...
        it("Should show you the answer", () => {
            ...
            expect(screen.getAllByRole("heading")[3].outerHTML).toEqual(`<h3 class="answer"><span>B4</span><span class="highlight">D#5</span><span>F5</span></h3>`)
        })
        it("Should move the the next part of the question", () => {
            ...
            userEvent.click(screen.getByRole("checkbox"))
            userEvent.click(buttons[3])
            expect(screen.getAllByRole("heading")[3].outerHTML).toEqual(`<h3 class="answer"><span>B4</span><span>D#5</span><span class="highlight">F5</span></h3>`)
        })
    })
})