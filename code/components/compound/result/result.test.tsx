...
function MockResult({answer}: {answer:IStdNote[]}) {
    ...
    return <Result question={questionGeneration.question[questionGeneration.current]} answer={answer} nextQuestion={questionGeneration.nextQuestion}/>
}
...
describe("answer", () => {
    ...
    describe("Test results", () => {
        ...
        it("give you the correct score", () => {
            ...
            act(() => {
                jest.advanceTimersByTime(1568)
                component.rerender(<MockResult answer={[StdNote("C4"), StdNote("G5")]} />)
            })
