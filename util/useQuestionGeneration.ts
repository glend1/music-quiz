...
import { useArray, useCounter } from "./customHooks";
import { randomFromRange } from "./maths"
import { Chord, createInterval, DirectionType, generateRandomNote, IStdNote, randomChord, StdNote } from "./notes"
...
export function useQuestionGeneration() {
    ...
    function newInterval(intervalRange: number, direction: DirectionType, iRoot = root) {
        if (iRoot) {
    ...
    return {root, newRoot, chord, newChord, interval, newInterval, question: answers.array, current, type, nextQuestion}
}