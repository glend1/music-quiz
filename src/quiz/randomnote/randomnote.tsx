import { getNaturalNoteFromArray } from "../../notes/notes/notes";
...
export function RandomNote({
	...
	newQuestion: (min: number, max: number, accidental: boolean) => void;
}) {
	...
	return (
		<>
			...
			<button
				onClick={() => {
					newQuestion(parseInt(min), parseInt(max), accidental);
				}}
			>
				New Note
			</button>
