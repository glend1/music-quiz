...
import { TChords } from '../../units/dictionaryutils/dictionaryutils';
import { Dispatch, SetStateAction } from 'react';
import { ChordSelector } from '../chordselector/chordselector';
import { Scales } from '../scales/scales';

export function ChordGroup({chords, setChords}: { chords: TChords; setChords: Dispatch<SetStateAction<TChords>>; }) {
    let notes = new Map()
